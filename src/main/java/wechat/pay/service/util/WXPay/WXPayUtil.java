package wechat.pay.service.util.WXPay;
...
import wechat.pay.service.service.config.WXPayConfigImpl;
import wechat.pay.service.util.WXPay.WXPayConstants.SignType;
...
public class WXPayUtil {
    ...
    public static Map<String, Object> xmlToMap(String strXML) throws Exception {
        try {
            ...
            getLogger().error("Invalid XML, can not convert to map. Error message: {}. XML content: {}", ex.getMessage(), strXML);
            throw ex;
        }
     ...
     * @return
     * @author lichenyi
     * @date 2017-8-28 0028 11:43
     */
    public static String generateSignedXml(final Map<String, Object> data) throws Exception {
        return generateSignedXml(data, WXPayConfigImpl.getInstance().getKey(), SignType.MD5);
    }
     ...
     * @return
     * @author lichenyi
     * @date 2017-8-29 0029 15:10
     */
    public static String generateSignedStr(final Map<String, Object> data) throws Exception {
        String sign = generateSignature(data, WXPayConstants.PAY_STORE_KEY, SignType.MD5);
        return sign;
    }
    ...
    public static boolean isSignatureValid(String xmlStr) throws Exception {
        return isSignatureValid(xmlStr, WXPayConstants.PAY_STORE_KEY);
    }
    /**
     * 判断签名是否正确
     *
    ...
    public static Logger getLogger() {
        Logger logger = LogManager.getLogger("wxpay java sdk");
        return logger;
    }
